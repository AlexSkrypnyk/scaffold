    ...
    const loadAsciinemaPlayer = async () => {
      ...
      try {
        if (!document.querySelector('link[href*="asciinema-player.css"]')) {
          ...
          link.rel = 'stylesheet';
          link.href =
            'https://cdn.jsdelivr.net/npm/asciinema-player@__VERSION__/dist/bundle/asciinema-player.css';
        ...
        if (!window.AsciinemaPlayer) {
          ...
          script.src =
            'https://cdn.jsdelivr.net/npm/asciinema-player@__VERSION__/dist/bundle/asciinema-player.min.js';
          script.onload = () => {
