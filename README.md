...
- **AI agents**
  ...
  - Optional AI-maintained [architecture documentation](docs/architecture/README.md) with Mermaid or PlantUML diagrams, generated and kept current by the bundled [`update-architecture-docs`](.claude/skills/update-architecture-docs/SKILL.md) skill
